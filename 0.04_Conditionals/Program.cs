...
namespace _0._04_Conditionals
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            string feelingNumber = Console.ReadLine();//Take input in console in order to set feelingNumber value.
            ...
            else//must have this else. Default option if entering anything besides 1-5.
            {
